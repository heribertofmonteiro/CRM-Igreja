...
-- Versão simplificada sem foreign keys para teste
...
INSERT INTO ministerios (nome, descricao, lider_id) VALUES 
('Ministério de Louvor', 'Responsável pela música e adoração nos cultos', 1),
('Ministério de Ensino', 'Escola Bíblica Dominical e estudos bíblicos', 1),
('Ministério de Ação Social', 'Apoio a famílias carentes e projetos sociais', 1);

INSERT INTO ministerio_membros (ministerio_id, membro_id, funcao, data_entrada) VALUES 
(1, 1, 'Líder de Louvor', CURDATE()),
(1, 2, 'Músico', CURDATE()),
(2, 1, 'Professor', CURDATE()),
(3, 1, 'Coordenador', CURDATE());
