...
$csp = [
    ...
    "object-src 'none'",
    "style-src 'self' 'unsafe-inline' fonts.googleapis.com translate.googleapis.com www.gstatic.com",
    "img-src 'self' data:",
    "media-src 'self'",
    "frame-src 'self'",
...
// Additional security headers (these complement Apache-level headers)
