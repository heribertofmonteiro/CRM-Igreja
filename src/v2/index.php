...
// Módulo Ministério - Rotas API
// O $app é passado como variável global para o arquivo de rotas do módulo
if (file_exists(__DIR__ . '/../modules/ministerio/v2/routes/ministerio.php')) {
    $moduleApp = $app; // Garantir que $app está disponível no módulo
